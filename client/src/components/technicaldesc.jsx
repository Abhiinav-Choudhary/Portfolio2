...
export const TechnicalDesc = () => {
  ...
  return (
    <section
      className="relative overflow-hidden w-full min-h-screen flex flex-col-reverse md:flex-row items-center justify-center 
                 bg-transparent text-gray-900 dark:text-white px-6 sm:px-10 md:px-20 py-16 gap-8 md:gap-12 transition-colors duration-500"
    >
      {/* 🔥 NET BACKGROUND */}
      <NetBackground />
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          skilled in building intelligent, scalable, and modern web
          applications. I love combining{" "}
          <span className="text-blue-400 dark:text-blue-300 font-semibold">
      ...
      <motion.div
        ...
        className="relative z-10 flex-shrink-0 mb-6 md:mb-0"
      >
        <img
          src="/avtar.avif"
